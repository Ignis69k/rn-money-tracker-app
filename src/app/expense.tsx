    ...
    <View style={styles.container}>
      ...
      >
        ...
        >
          ...
          <Text style={styles.heading}>เพิ่มรายจ่าย</Text>
          <Text style={styles.subheading}>บันทึกรายจ่ายของคุณ</Text>
          ...
          >
            ...
            >
              <LinearGradient
                colors={loading ? ["#6b4b4b", "#6b4b4b"] : ["#dc2626", "#ef4444"]}
                start={{ x: 0, y: 0 }}
                end={{ x: 1, y: 1 }}
